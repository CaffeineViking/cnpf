        ...
        uint const seed)
{
    ...
    positions[2*id+0] =  positions[2*id+0] + rand(seed * id)/5000;
	positions[2*id+1] = positions[2*id+1]  + rand(seed ^ id)/5000;
    positions[3*id+2] = positions[3*id+2]  + rand(seed ^ id)/5000;
}